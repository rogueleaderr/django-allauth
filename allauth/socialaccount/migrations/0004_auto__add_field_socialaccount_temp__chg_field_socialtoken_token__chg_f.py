...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SocialAccount.temp'
        db.add_column('socialaccount_socialaccount', 'temp',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'SocialToken.token'
        db.alter_column('socialaccount_socialtoken', 'token', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'SocialToken.token_secret'
        db.alter_column('socialaccount_socialtoken', 'token_secret', self.gf('django.db.models.fields.CharField')(max_length=400))

    def backwards(self, orm):
        # Deleting field 'SocialAccount.temp'
        db.delete_column('socialaccount_socialaccount', 'temp')
    ...
    models = {
        ...
        'socialaccount.socialaccount': {
            ...
            'temp': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'socialaccount.socialtoken': {
            ...
            'token_secret': ('django.db.models.fields.CharField', [], {'max_length': '400', 'blank': 'True'})
        }
    }
